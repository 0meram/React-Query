...
const Fetcher = () => {
  ...
  return (
    <div style={{ textAlign: "left", width: "700px" }}>
      <h2>
        Unlike the useQuery hook, mutations are used to perform CREATE, UPDATE,
        or DELETE operations as the server-side operations inside our
        components.
      </h2>
      <h1>
        Making a POST request using{" "}
        <span style={{ color: "red" }}>‘useMutation’ hook</span>
      </h1>
      <div className="post">
        <h1>Create a Post</h1>
